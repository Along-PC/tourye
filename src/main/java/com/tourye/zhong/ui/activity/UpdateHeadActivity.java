...
import com.tourye.zhong.views.dialogs.ModifyHeadDialog;
...
public class UpdateHeadActivity extends AppCompatActivity implements View.OnClickListener {
                ...
                .subscribe(new Consumer<Boolean>() {
                    ...
                    public void accept(Boolean aBoolean) throws Exception {
                        if (aBoolean) {
                            ...
                            PermissionDialogUtil.showPermissionDialog(UpdateHeadActivity.this, "缺少拍照或存储相关权限，请前往手机设置开启");
                        }
                    }
                });
    }
